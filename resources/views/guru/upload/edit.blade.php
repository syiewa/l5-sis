...
<div class="row" ng-controller="uploadedit">
    <div class="col-sm-12">
        <div class="tabbable">
                ...
                <div id="panel_tab2_example1" class="tab-pane active">
                    ...
                    <form class="form-horizontal" role="form" name="beritaForm" ng-submit="submit()" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type='text' class='col-sm-10 form-control' name='judul_file' ng-model='data.judul_file'/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <a href='{{route('admin.upload.index')}}' class="btn btn-blue">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
