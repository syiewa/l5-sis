...
@stop
@section('content')
<div class="main-content" ng-controller="galeriedit">
    <div class="container">
        <!-- start: PAGE HEADER -->
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <div id="panel_tab2_example1" class="tab-pane active">
                             ...
                             <form class="form-horizontal" role="form" name="agendaForm" ng-submit="submit({{$data->id_album}})" enctype="multipart/form-data">
